    ...
    <form  action="" modelAttribute="res" method="post" class="form form-horizontal" id="form-member-add" enctype="multipart/form-data">
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <input type="text" class="input-text" value="${item.title}" placeholder="" id="username" name="title">
            </div>
        </div>
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="check-box">
                	<c:if test="${item.topper==1 }">
                		 <input type="checkbox" checked="checked" id="checkbox-2" name="topper" value="1" >
                	</c:if>
                   <c:if test="${item.topper!=1 }">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                <div class="check-box">
                	<c:if test="${item.prof==0}">
                	<input type="checkbox" checked="checked" id="checkbox-2" name="prof" value="0" >
                	</c:if>
                	<c:if test="${item.prof!=0}">
        ...
        <div class="row cl">
         ...
         <textarea id="context" cols="20" rows="2" name="context" class="ckeditor">
         ${item.context }
         </textarea>
	...
	function Submit(){
		...
		$.ajax({
	        ...
	        success: function (date )
	        {
	           ...
	           if(date.code=='1000'){
					alert(date.msg);
					window.location.href="editSolves?id="+${item.id};
	           }
	        },
	        error:function (date) {      
	            alert("请求失败！");
