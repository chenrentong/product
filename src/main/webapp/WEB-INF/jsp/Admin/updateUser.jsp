    ...
    <form action="" class="form form-horizontal" method="post" id="form-admin-add">
        <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input class="input-text" autocomplete="off" value="${user.password}" placeholder="密码" id="password" name="password">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>确认密码：</label>
                <div class="formControls col-xs-8 col-sm-9">
                    <input  class="input-text" autocomplete="off" value="${user.password}"  placeholder="确认新密码" id="passwordTo" name="passwordTo">
                </div>
            </div>
        </if>
        <div class="row cl">
            ...
            <c:if test="${user.sex!=true}">
           		<div class="radio-box">
                	<input name="sexto" type="radio" value="1" id="sex-1" >
                    <label for="sex-1">男</label>
                </div>
                <div class="radio-box">
                    <input type="radio" id="sex-2" value="2" name="sexto" checked >
                    <label for="sex-2">女</label>
                </div>
...
function Submit(){
	...
	$.ajax({
        ...
        success: function (date )
        {
           ...
           if(date.code=='1000'){
				alert(date.msg);
				window.location.href="updateUser?id="+${user.id};
           }
        },
        error:function (date) {      
            alert("请求失败！");
